    ...
    const hws = [
        {
            "deadline":"Yesterday",
            "hw":[
                {"subject":"maths", "topic":"Calculus", "accuracy":"75%", "teacher":"Abhishek Das sir", "attempted":"20/25","quesData":quesData},
                {"subject":"physics", "topic":"Vectors", "accuracy":"55%", "teacher":"Mahesh Sharma sir", "attempted":"15/20","quesData":quesData}
        ]},
        {
        ...
        return(
            <>
                ...
                renderItem={({item})=><HomeWorkComponent leftBottom={item.attempted+" Attempted"} teacher={item.teacher} 
                    subject={item.subject} rightBottom={item.accuracy+" Accuracy"} topic={item.topic} quesData={item.quesData}/>}
                />
            </>
        )
    }
